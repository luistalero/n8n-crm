	...
	it('should send message and put execution to wait', async () => {
		...
		expect(transport.microsoftApiRequest).toHaveBeenCalledWith(
			...
			'/v1.0/chats/chatID/messages',
			{
				body: {
					content:
						'my message<br><br><a href="https://localhost/waiting-webhook/nodeID?approved=true&signature=abc">Approve</a><br><br><em>This message was sent automatically with <a href="https://n8n.io/?utm_source=n8n-internal&utm_medium=powered_by&utm_campaign=n8n-nodes-base.microsoftTeams_instanceId">n8n</a></em>',
					contentType: 'html',
				},
			},
		);
