...
describe('saml-validator', () => {
		...
		test('successfully validates metadata containing ws federation tags', async () => {
			...
			<EntityDescriptor ID="_1069c6df-0612-4058-ae4e-1987ca45431b"
				...
				<RoleDescriptor xsi:type="fed:SecurityTokenServiceType"
					protocolSupportEnumeration="https://docs.oasis-open.org/wsfed/federation/200706"
					...
					<fed:ClaimTypesOffered>
						<auth:ClaimType Uri="https://schemas.xmlsoap.org/ws/2005/05/identity/claims/name"
						...
						<auth:ClaimType Uri="https://schemas.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
						...
						<auth:ClaimType Uri="https://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
							<auth:DisplayName>Given Name</auth:DisplayName>
							<auth:Description>First name of the user.</auth:Description>
						</auth:ClaimType>
						<auth:ClaimType Uri="https://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
							<auth:DisplayName>Surname</auth:DisplayName>
							<auth:Description>Last name of the user.</auth:Description>
						</auth:ClaimType>
						<auth:ClaimType Uri="https://schemas.microsoft.com/identity/claims/displayname"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
							<auth:DisplayName>Display Name</auth:DisplayName>
							<auth:Description>Display name of the user.</auth:Description>
						</auth:ClaimType>
						<auth:ClaimType Uri="https://schemas.microsoft.com/identity/claims/nickname"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
							<auth:DisplayName>Nick Name</auth:DisplayName>
							<auth:Description>Nick name of the user.</auth:Description>
						</auth:ClaimType>
						<auth:ClaimType
							Uri="https://schemas.microsoft.com/ws/2008/06/identity/claims/authenticationinstant"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
						...
						<auth:ClaimType
							Uri="https://schemas.microsoft.com/ws/2008/06/identity/claims/authenticationmethod"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
							<auth:DisplayName>Authentication Method</auth:DisplayName>
							<auth:Description>The method that Windows Azure Active Directory uses to authenticate users.</auth:Description>
						</auth:ClaimType>
						<auth:ClaimType Uri="https://schemas.microsoft.com/identity/claims/objectidentifier"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
						...
						<auth:ClaimType Uri="https://schemas.microsoft.com/identity/claims/tenantid"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
							<auth:DisplayName>TenantId</auth:DisplayName>
							<auth:Description>Identifier for the user's tenant.</auth:Description>
						</auth:ClaimType>
						<auth:ClaimType Uri="https://schemas.microsoft.com/identity/claims/identityprovider"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
							<auth:DisplayName>IdentityProvider</auth:DisplayName>
							<auth:Description>Identity provider for the user.</auth:Description>
						</auth:ClaimType>
						<auth:ClaimType Uri="https://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
							<auth:DisplayName>Email</auth:DisplayName>
							<auth:Description>Email address of the user.</auth:Description>
						</auth:ClaimType>
						<auth:ClaimType Uri="https://schemas.microsoft.com/ws/2008/06/identity/claims/groups"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
							<auth:DisplayName>Groups</auth:DisplayName>
							<auth:Description>Groups of the user.</auth:Description>
						</auth:ClaimType>
						<auth:ClaimType Uri="https://schemas.microsoft.com/identity/claims/accesstoken"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
						...
						<auth:ClaimType Uri="https://schemas.microsoft.com/ws/2008/06/identity/claims/expiration"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
						...
						<auth:ClaimType Uri="https://schemas.microsoft.com/identity/claims/openid2_id"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
						...
						<auth:ClaimType Uri="https://schemas.microsoft.com/claims/groups.link"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
						...
						<auth:ClaimType Uri="https://schemas.microsoft.com/ws/2008/06/identity/claims/role"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
						...
						<auth:ClaimType Uri="https://schemas.microsoft.com/ws/2008/06/identity/claims/wids"
							xmlns:auth="https://docs.oasis-open.org/wsfed/authorization/200706">
	...
	<Assertion ID="_random_id" IssueInstant="2024-11-13T14:58:00.367Z"
		...
		<Conditions NotBefore="2024-11-13T14:53:00.284Z" NotOnOrAfter="2024-11-13T15:58:00.284Z">
			<AudienceRestriction>
				<Audience>https://n8n-crm-njv9.onrender.com/rest/sso/saml/metadata</Audience>
			</AudienceRestriction>
		</Conditions>
		<AttributeStatement>
			...
			<Attribute Name="https://schemas.microsoft.com/identity/claims/displayname">
			...
			<Attribute Name="https://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress">
			...
			<Attribute Name="https://schemas.xmlsoap.org/ws/2005/05/identity/claims/firstname/firstname">
				<AttributeValue>Danny</AttributeValue>
			</Attribute>
			<Attribute Name="https://schemas.xmlsoap.org/ws/2005/05/identity/claims/lastname/lastname">
				<AttributeValue>Martini</AttributeValue>
			</Attribute>
			<Attribute Name="https://schemas.xmlsoap.org/ws/2005/05/identity/claims/upn/upn">
				<AttributeValue>danny@n8n.io</AttributeValue>
			</Attribute>
		</AttributeStatement>
