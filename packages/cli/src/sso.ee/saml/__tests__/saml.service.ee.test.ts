...
const InvalidSamlSetting: Settings = {
	...
	value: JSON.stringify({
		...
		relayState: 'https://n8n-crm-njv9.onrender.com',
		signatureConfig: {
			prefix: 'ds',
		...
		test('throws when any attribute is missing', async () => {
			...
			jest.spyOn(samlHelpers, 'getMappedSamlAttributesFromFlowResult').mockReturnValue({
				...
				missingAttributes: [
					...
					'https://schemas.xmlsoap.org/ws/2005/05/identity/claims/lastname',
			...
			await expect(
				...
				'SAML Authentication failed. Invalid SAML response (missing attributes: https://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress, https://schemas.xmlsoap.org/ws/2005/05/identity/claims/firstname, https://schemas.xmlsoap.org/ws/2005/05/identity/claims/lastname, https://schemas.xmlsoap.org/ws/2005/05/identity/claims/upn).',
			);
		});
	});
