		...
		it('should return a valid auth URI', async () => {
			...
			nock('https://example.domain')
				.post('/oauth/request_token', {
					oauth_callback:
						'https://n8n-crm-njv9.onrender.com/rest/oauth1-credential/callback?state=eyJ0b2tlbiI6InRva2VuIiwiY2lkIjoiMSIsImNyZWF0ZWRBdCI6MTcwNjc1MDYyNTY3OCwidXNlcklkIjoiMTIzIn0=',
				})
				.once()
